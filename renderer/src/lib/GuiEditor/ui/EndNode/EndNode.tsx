...
const EndNode = ({ selected }: NodeProps<BlockData>) => {
  return (
    <div>
      <section
      ...
      >
        <h2 className="px-3 py-2 leading-none text bg-stone-600 flex items-center gap-2">END</h2>
        <div className="p-3 flex">
          <div className="w-full flex flex-col items-end gap-y-4 flex-1">
            <div className="flex items-center gap-x-2">
              <div className="text-sm">終了</div>
